...
خلاصهٔ سریع به فارسی:
- شما مجوز دارید کد را استفاده، کپی، تغییر و توزیع کنید.
- این نرم‌افزار "AS IS" ارائه می‌شود و هیچ گونه ضمانتی ندارد.

در بالای فایل `LICENSE` شناسهٔ SPDX (`SPDX-License-Identifier: MIT`) قرار دارد که برای ابزارهای خودکار و مدیریت لایسنس مفید است.

اگر می‌خواهید نام صاحب حقوق نشر را تغییر دهید، فایل `LICENSE` را ویرایش کنید (مقدار مالک در بالای فایل قرار گرفته است).
