...
تمامی حقوق این پروژه محفوظ به شرکت سازنده است. به عبارت دیگر، همهٔ حقوق متعلق به مالک پروژه است و هرگونه استفاده، بازتولید، توزیع یا تغییر نیاز به اجازهٔ کتبی دارد.
---
